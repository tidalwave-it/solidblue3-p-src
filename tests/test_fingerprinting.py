...
#  __version__ = "1.0-ALPHA-2-SNAPSHOT"
...
class TestFingerprintControl(unittest.TestCase):
    ...
    def test_veracrypt_post_processor(self):
        ...
        self.maxDiff = None
        expected = [('notify_secondary_progress()', 0.126),
    ...
    def test_drutil_post_processor(self):
        ...
        expected = [('notify_message()', 'Burning Image to Disc: /tmp/SolidBlue/FG-2019-0001,0002 #2.dmg'),
